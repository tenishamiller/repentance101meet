    ...
    <div className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden bg-burgundy-dark">
      ...
      <div className="relative min-h-0 overflow-hidden">
        <div
          ...
          className="livestream-panel-scroll chat-scroll chat-scroll-dark absolute inset-0 overflow-y-auto overscroll-y-contain p-4"
        >
        {messages.length === 0 && (
      ...
      <form
        ...
        className="border-t border-gold/20 bg-burgundy-dark p-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] sm:p-3"
      >
        {uploadError && (
