      ...
      ? createPortal(
          <>
            ...
            <div
              ...
              className="fixed inset-x-3 bottom-3 z-[201] max-h-[min(75vh,calc(100dvh-5rem))] overflow-y-auto rounded-xl border border-gold/30 bg-burgundy-dark p-4 shadow-2xl sm:inset-x-auto sm:bottom-24 sm:right-4 sm:w-[22rem]"
            >
              ...
              <p className="mb-3 text-xs leading-relaxed text-gold-light/75">
                ...
                teaching room so YouTube shows the same view (screen on the left, you and members on
                the right).
              </p>
